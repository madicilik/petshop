...
if (isset($_POST['ubah'])) {
  ...
  // jika foto dirubah
  if (!empty($lokasifoto)) {
    move_uploaded_file($lokasifoto, "../foto_pemeliharaan/$namafoto");

    $koneksi->query("UPDATE pemeliharaan SET judul='$_POST[judul]', paragraf='$_POST[paragraf]', gambar='$namafoto' WHERE id_pemeliharaan='$_GET[id]'");
  } else {
    $koneksi->query("UPDATE pemeliharaan SET judul='$_POST[judul]', paragraf='$_POST[paragraf]' WHERE id_pemeliharaan='$_GET[id]'");
  }
      ...
      <div class="col-md-12">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <img src="../foto_pemeliharaan/<?= $pecah['gambar'] ?>" width="200">
          </div>
          <div class="form-group">
